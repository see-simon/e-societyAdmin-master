                                ...
                                <Form className="form">
                                    <div className="inputs-con">
                                        <div className="mb-4 mt-5 w-75 input-in">
                                            ...
                                            <input type="email" class="form-control" id="userEmailAccount" aria-describedby="userEmail" placeholder='example@gmail.com'></input>
                                        </div>

                                        <div className="mb-0 w-75 input-in">
                                            {/* <label for="exampleInputEmail1" class="form-label acc-label">Email Address</label> */}
                                            <div className="acc-icon-input"><i class="bi bi-lock-fill"></i></div>
                                            <input type="email" class="form-control" id="userEmailAccount" aria-describedby="userEmail" placeholder='Enter Password'></input>
                                        </div>
                                    </div>
